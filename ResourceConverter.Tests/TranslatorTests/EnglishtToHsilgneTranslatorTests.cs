...
{
    [TestClass()]
    public class EnglishtToHsilgneTranslatorTests
    {
        [TestMethod()]
        public void TranslateTest_NoUppercase()
        {
            //Arrange
            EnglishtToHsilgneTranslator translator = new EnglishtToHsilgneTranslator();
            ...
            //Assert
            Assert.AreEqual("gnirts_elpmaS", result1);
            Assert.AreEqual("Gnirts_elpmaS", result2);
            Assert.AreEqual("gnirts_elpmas", result3);
        }
